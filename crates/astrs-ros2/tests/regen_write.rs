//! Materializes `src/interfaces/` from `msg-src/` by hand: `cargo test -p
//! astrs-ros2 --test regen_write -- --ignored`.
//!
...
//! commit it; `interfaces_match_source.rs` is what keeps the committed
...
#[test]
#[ignore = "writes to src/interfaces/; run explicitly to regenerate the ROS 2 interface packages"]
fn write_generated_interfaces() {
